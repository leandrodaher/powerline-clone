(function(s, x, k) {
    ...
    function Lb() {
        4 <= Y && T && (Mb || (k("#overlay").css({
            ...
            Mb = !0), ta++, 2 < ta && (ta = 0), nextTipID = ta, ba = !0);
        setTimeout(Lb, 2500)
    }

    function Hb() {
        if (!debug)
            if (null != adsense && adsense) 0 == Nb ? cpmstarAPI({
                kind: "createmodule",
                module: "anchor79284",
                config: {
                    kind: "anchor",
                ...
                module: "anchor79284",
                command: "refresh"
            }), s.googletag && (s.googletag.cmd.push(function() {
    ...
    x.body.onselectstart =
        function() {
            return !1
        };
    s.clickPlay = function(a) {
        L.clearSpeedupTutorial();
        n.hasConnection ? U ? Gb() : (s.localStorage.nick = a, ub++, va.mouseMoved = !1, n.sendNick(a, tb), 6 > ub && I && 0 == ub % 3 && I.showTip("Press 'M' to Toggle Sounds", 4E3), tb && (k("#continueTop").hide(), k("#continueBR").hide(), k("#continue").hide(), k("#nickInput").show(), k("#skinPanel").hide(), k("#howto").show(), k("#beta").show(), tb = !1)) : (k("#topGui").hide(), k("#topGuiConnecting").show())
    };
    ...
    s.toggleSound = function() {
        ...
        1 == S ? (R = S = 0, I &&
            I.showTip("Sounds Disabled", 3E3)) : 0 == S && (R = S = 1, a = "images/sound_on.png", I && I.showTip("Sounds Enabled", 3E3));
    ...
    ka.prototype = {
        ...
        setVMargin: function(a) {
            a !=
                this._vmargin && (this._vmargin = a, this._dirty = !0)
        },
        ...
        render: function() {
            null == this._canvas && (this._canvas = x.createElement("canvas"),
            ...
            if (this._dirty) {
                ...
                c.scale(d, d);
                c.globalAlpha = 1;
                this._usingRoundedFrame && (c.fillStyle = this._roundedFrameStyle,
                    c.globalAlpha = this._frameOpacity, Ra(c, 0, 0, a.width, a.height, 30), c.globalAlpha = 1);
                a = l + b / 2;
    ...
    var qc = function() {
            ...
            this.gameSheet;
            this.frames = {};
            this.skullRedGlow = this.skullDarkBlueGlow =
                this.skullPurpleGlow = this.skullRed = this.skullDarkBlue = this.skullPurple = this.bgGrid = this.boostImage = this.keysImage = null;
        ...
        rc = function() {
            ...
            a.mousedown = function(a) {
                N || (f++, 2 < f && (ia = void 0, f = c = 0), Rb = a.clientX, Sb = a.clientY)
            };
            a.keydown = function(d) {
                ...
                if (N && f) 13 == d.keyCode || 32 == d.keyCode ? clickPlay(s.localStorage.nick) : 27 ==
                    d.keyCode && (k("#statsPanel").hide(), k("#basePanel").show(), k("#nick").focus());
                else if (67 == d.keyCode && N && La) setTimeout(function() {
                    Fb()
                }, 10);
                else if (!N) {
                    32 == d.keyCode && void 0 != ia && 0 != ia && (Ca = 1E3);
                    73 == d.keyCode && (Xa ? (H.domElement.style.visibility = "hidden", M.domElement.style.visibility = "hidden") : (H.domElement.style.visibility = "visible", M.domElement.style.visibility = "visible", n.ping()), Xa = !Xa);
                    B && 0 < Ja && (49 <= d.keyCode && 57 >= d.keyCode || 48 == d.keyCode ? B.canTalk() ? 49 <= d.keyCode && 57 >= d.keyCode ? (n.sendTalk(d.keyCode -
                        49 + 1), I.hideTalkLayer()) : 48 == d.keyCode && (n.sendTalk(10), I.hideTalkLayer()) : I.cantTalk() : 84 == d.keyCode && I.toggleTalkLayer());
                    if (debug)
                        if (75 == d.keyCode) n.leave();
                        else if (76 == d.keyCode) Ga || n.bigPicture(), z.x = 0, z.y = 0, z.zoom = .3599, U = !1, Ga = !0;
                    ...
                    B ? (e = B.x, f = B.y, g = db, 38 == d.keyCode || 87 == d.keyCode ? 1 != a.direction &&
                        3 != a.direction && 0 != a.direction && (a.direction = 1, a.turn(a.direction, e, f, g, 0)) : 37 == d.keyCode || 65 == d.keyCode ? 2 != a.direction && 4 != a.direction && 0 != a.direction && (a.direction = 2, a.turn(a.direction, e, f, g, 0)) : 40 == d.keyCode || 83 == d.keyCode ? 3 != a.direction && 1 != a.direction && 0 != a.direction && (a.direction = 3, a.turn(a.direction, e, f, g, 0)) : 39 != d.keyCode && 68 != d.keyCode || 4 == a.direction || 2 == a.direction || 0 == a.direction || (a.direction = 4, a.turn(a.direction, e, f, g, 0))) : Ga && (e = .01, d.shiftKey && (e = .1), 38 == d.keyCode ? z.zoom += e : 40 == d.keyCode &&
                        (z.zoom -= e), console.log(z.zoom), console.log(da / 10));
                    70 == d.keyCode ? (x.fullscreenElement || x.mozFullScreenElement || x.webkitFullscreenElement || x.msFullscreenElement ? x.exitFullscreen ? x.exitFullscreen() : x.msExitFullscreen ? x.msExitFullscreen() : x.mozCancelFullScreen ? x.mozCancelFullScreen() : x.webkitExitFullscreen && x.webkitExitFullscreen() : x.documentElement.requestFullscreen ? x.documentElement.requestFullscreen() : x.documentElement.msRequestFullscreen ? x.documentElement.msRequestFullscreen() : x.documentElement.mozRequestFullScreen ?
                        x.documentElement.mozRequestFullScreen() : x.documentElement.webkitRequestFullscreen && x.documentElement.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT), I.clearTip()) : 77 == d.keyCode ? toggleSound() : 90 == d.keyCode && debug && U && (xb = !xb);
            ...
            this.turn = function(a, f, g, e, b) {
                c++;
                Ab ? (f = +new Date, g = f - Yb, Yb = f, 30 > g && (e += 30), e = B.addTurnPoint(a, e), f = 10 * e.x, g = 10 * e.y, n.sendTurnPoint(a, 1 == a || 3 == a ? f / 10 : -g / 10)) : n.sendDirection(a)
            };
        ...
        sc = function() {
                ...
                if (50 > +new Date - P && T) {
                    ...
                    if (e) {
                        ...
                        g != WEAPON_LASER && (g = Math.sqrt(e * e + d * d), b.direction = {
                            ...
                            x: f,
                            y: c
                        }, b.finish = !1, (Aa(f, c, 100) || Aa(b.hitPosition.x,
                            b.hitPosition.y, 100)) && a.push(b));
                        g = areaHeight / 2;
            ...
            this.addSplash = function(a, d, c, g) {
                if (drawSplashes && !gameEvent.isSpaceWars() && Aa(a, d, 100) && 50 >
                    +new Date - P) {
        ...
        uc = function() {
            ...
            this.draw = function(m) {
                if (0 < d) {
                    ...
                    if (!g) {
                        var n = 22;
                        f ? (e = new ka(36 * q, "#00FFFF", !1, "#00AAAA"), e.setValue(f), e.setUsingRoundedFrame(!0), C = !0, e.setAddTop(35), e.setShadowBlur(4)) : (e = null, n = 35);
                    ...
                    m.save();
                    m.scale(q, q);
                    hb && m.drawImage(hb, .5 * canvas.width / q - hb.width / 2, (n - 5) / q);
                    m.drawImage(t, .5 * canvas.width / q - t.width / 2, n / q);
                    m.restore();
                    m.globalAlpha = 1
                }
                0 < r && (k = 0, C = +new Date - r, 4E3 > C ? 3E3 > C ? (k = C / 200, 1 < k && (k = 1)) : k = 1 - (C - 3E3) / 1E3 : r = 0, C = !1, b || (n = v, b = new ka(n * q, "#00FFFF", !1, "#00AAAA"), b.setValue(l), b.setUsingRoundedFrame(!C), b.setShadowBlur(3), b.setAddTop(-2)), n = .7 * canvas.height, b.setColor("#00FFFF"), b.setStrokeColor("#00FFFF"),
                    b.setRoundedFrameStyle("#00FFFF"), b.setRoundedFrameOpacity(.11), t = b.render(), m.globalAlpha = k, m.save(), m.scale(q, q), m.drawImage(t, .5 * canvas.width / q - t.width / 2, n / q), m.restore(), m.globalAlpha = 1);
                if (U && B) {
                    ...
                    m.scale(q, q);
                    if (0 < Ja) {
                        var qa = B.talkStamina /
                            255;
                        255 == B.talkStamina && 255 > Y && (s.localStorage.talk ? s.localStorage.talk++ : s.localStorage.talk = 1, 7 >= s.localStorage.talk && 0 == s.localStorage.talk % 2 && I.showTip("Press T to talk", 4E3));
                        Y = B.talkStamina;
                        m.globalAlpha = 1 == qa ? .3 : .1 + .6 * $;
                ...
                J && (u =
                    x.createElement("canvas"), k = u.getContext("2d"), this.renderLeaderboard(k, u), J = !1);
                u && U && this.drawLeaderboard(m);
                y && (0 < Ka && ya || !ya || 0 < E) && (null == D && (k = parseInt(20 * q) + 1, z = new ka(k, F, !1, F), z.setValue(y), z.setUsingRoundedFrame(!0), z.setRoundedFrameStyle(A), z.setShadowBlur(2), D = z.render()), m.drawImage(D, ea / 2 - D.width / 2, 1.1 * D.height * (X ? 1 - E / 300 : E / 300) - D.height));
                !N && 0 < Ja && ja.draw(m);
                a != q && (a = q)
            };
            ...
            this.renderLeaderboard = function(b, a) {
                ...
                for (var h = C.length, ib = 0, jb = !1, Q = 0; Q < h; Q++) {
                    var K = C[Q];
                    K && (Z !=
                        K.id || jb || (jb = !0), e(K.nick.substring(0, 16)))
                }!jb && B && e(B.nick);
                ib > r && (m += ib - r);
                k = m * q;
                a.width = k;
                ...
                for (Q = 0; Q < h; Q++)
                    if (K = C[Q]) {
                        ...
                        v && (b.save(), b.translate(6 + d + u + 10, f + A + c / 2 - 1), K = 1, aa || (K = .5), b.scale(.8 * K, .8 * K), t.frames.crown.draw(b),
                            b.restore());
                        f += c + l
                    }!jb && B && (b.fillStyle = "#09ffff", J = qa + ". " + Ba(B.nick), r = b.measureText(J).width, b.fillText(J, 6 + d, f + A + c / 2), r = b.measureText(w).width, b.fillText(w, k - d - r - 6, f + A + c / 2))
            };
        ...
        Cb = function() {
            ...
            this.update = function(a) {
                if (this.beingDeleted)
                    if (q) this.snakeScale -=
                        .1, 0 > this.snakeScale && (this.id == Z && (va.direction = 1, Z = 0, B = null, Ma = this.killReason, this.killedByID == this.id && (Ma = 3)), delete y[this.id], this.cleanup());
                    else {
                        ...
                        n = c;
                        ca += a;
                        3E3 < ca && !q && (debug && console.log("bf"), q = !0)
                    } else {
                    k = m;
                ...
                this.curLength +=
                    (this.curLengthDst - this.curLength) / 10;
                ...
                T ? N && (na *= .3) : na = 0;
                ga && this.playSounds && (ja -= .01, 0 > ja && (ja = 0), D.sound._nodeById(ga).bufferSource.playbackRate.value = .8 + r / 100 * 1.5 - ja, D.sound.volume((ec + r / 100 * (vc - ec)) * na * R, ga));
                $ && this.playSounds && (c = Math.max(0, (r - 30) / 70), D.sound.volume(c * wc * na * R, $));
                V && this.playSounds && (D.sound._nodeById(V),
                    ha ? D.sound.volume(xc * na * R, V) : D.sound.volume(0, V));
                f && !wa && U && B == this && (ia += a, 2E3 < ia && (wa = 1, s.localStorage.speedUpTut = 1));
                a = a / 1E3 * 20;
                0 < ba ? (ra += a, a = .75 * Math.PI, ra > a && (ra = a)) : (ra -= a, 0 > ra && (ra = 0))
            };
            ...
            this.calcRenderPoints = function() {
                ...
                Z == this.id || this.tutorial || (c = Math.max(Wa / 2 + da / 2 - db + Zb, 0) * this.lastSpeed / za);
            ...
            this.drawAfter = function(b) {
                ...
                aa && (b.shadowColor = a, b.shadowBlur = 5);
                b.save();
                b.globalAlpha = 1 * c;
                b.beginPath();
                ...
                4E3 < this.curLength && aa && (a = 1, 4500 > this.curLength && (a = 1 - (4500 - this.curLength) / 500), b.globalAlpha = a * c, b.shadowBlur = 5, b.lineWidth = (e - 2) * this.snakeScale, a = "hsl(" + this.hue + ", 100%, 90%)", b.strokeStyle = a, b.shadowColor = a, a = e / 4 * 1.5, b.setLineDash([10 * a, 12 * a]), tt = 15 * G, b.lineDashOffset = tt, this.drawTail(this.renderedPoints, b), b.globalAlpha = 1);
                10 <
                    r && (a = (r - 10) / 50, 50 < r && (a = 1), b.globalAlpha = a * c, b.shadowBlur = 0, b.strokeStyle = "hsl(" + this.hue + ", 100%, 90%)", b.lineWidth = (e - .8) * this.snakeScale, this.drawTail(this.renderedPoints, b), b.globalAlpha = 1 * c);
                b.shadowBlur = 0;
                ...
                4 == a.length && (b.save(), l = a[0], b.translate(l.x, l.y), b.scale(.19 * e, .19 * e), J.draw(b), b.restore(), b.globalAlpha = .5 * c, b.save(), l = a[1], b.translate(l.x, l.y), b.scale(.16 * e, .16 * e), J.draw(b), b.restore(), b.globalAlpha = .3 * c, b.save(), l = a[2], b.translate(l.x, l.y), b.scale(.12 * e, .12 * e), J.draw(b), b.restore(), b.globalAlpha = .1 * c, b.save(), l = a[3],
                    b.translate(l.x, l.y), b.scale(.12 * e, .12 * e), J.draw(b), b.restore());
                b.globalAlpha = 1 * c;
            ...
            this.drawKillStreakIcon = function(b, a) {
                ...
                0 == e ? (t.frames.skullbase.draw(b), t.frames.skullglow.draw(b), 8 < a && t.frames.skulleyesred.draw(b)) : 1 == e ? (t.skullDarkBlue.draw(b),
                    t.skullDarkBlueGlow.draw(b), t.frames.skulleyesyellow.draw(b)) : 2 == e ? (t.skullPurple.draw(b), t.skullPurpleGlow.draw(b), t.frames.skulleyesgreen.draw(b)) : 3 == e && (t.skullRed.draw(b), t.skullRedGlow.draw(b), t.frames.skulleyesblue.draw(b));
            ...
            this.drawInfo =
                function(b) {
                    if (void 0 != this.headPos && !this.beingDeleted) {
                        ...
                        b.fillText(e, -d / 2, 30);
                        b.restore();
                        0 < ra && (b.save(), b.globalAlpha = 1, b.translate(this.headPos.x, this.headPos.y), e = Math.sin(ra), d = Math.sin(.75 * Math.PI), e > d && (e = d + .5 * (1 - d)), b.scale(e, e), b.fillStyle = "rgba(0, 60, 60, 1.0)", b.font = "Bold 8px 'proxima-nova-1','proxima-nova-2', Arial", b.textBaseline = "hanging", e = b.measureText(ma).width,
                            d = e / 2 + 13, l = e + 8, b.beginPath(), b.moveTo(-4, -4), b.lineTo(-27, -20), b.lineTo(-13, -20), b.closePath(), b.fill(), Ra(b, -l / 2 - d, -24.5, l, 13, 6), b.fillStyle = "rgba(0, 255, 255, 1.0)", b.fillText(ma, -e / 2 - d, -20), b.restore())
                    }
                };
            this.updateNetwork = function(a, c, u) {
                ...
                c += 2;
                0 == S && 0 >= O ? (this.origX = this.x,
                    this.origY = this.y, this.dstX = m, this.dstY = k) : (this.origX = this.x, this.origY = this.y, m = Oa(this.direction), this.dstX += m.x * this.lastSpeed, this.dstY += m.y * this.lastSpeed);
                k = a.getUint8(c, !0);
                c += 1;
                if (k & 1) {
                    a.getFloat32(c, !0);
                ...
                k & 2 ? (m = a.getFloat32(c, !0), c += 4, C = -a.getFloat32(c, !0), c += 4, w = a.getUint16(c, !0), c += 2, g = d, e = h, b = 10 * m, l = 10 * C, f || (d = b, h = l, g = b, e = l, f = !0)) : f = !1;
                v = k & 4 ? !0 : !1;
                k & 8 && (da = a.getUint16(c, !0), c += 2);
                ka = k & 16;
                k & 32 ? (W = a.getUint16(c, !0), c += 2, la != W && B == this && U && (la = W, I.addSpecialMessage(W + " PLAYER KILL STREAK", 25))) : W = 0;
                k & 64 ? (ba = a.getUint8(c, !0), c += 1, ta != ba && (ma = this.getTalkTextByTalkID(ba), ta = ba)) : ba = 0;
                this.talkStamina = a.getUint8(c, !0);
                c += 1;
                r = a.getUint8(c, !0) / 255 * 100;
                c += 1;
                B == this && (m = Math.max(0, Math.min(1, (this.curLengthDst - pb) / Ub)), wb = Ta - (Ta - Tb) * m);
                if (u) {
                    ...
                    if (this.id == Z && Ab) {
                        ...
                        this.playSounds && D.playSound(gc,
                            hc * na * R, 1, sa, null)
                    }
                }
                a = O;
            ...
            this.deleteNetwork = function(b, a) {
                this.id == Z && 4 <= Y + 1 && (cb = this.killedByID, xa = 30);
                this.killedByID == Z && this.id == pa && this.id != Z && U && I.addSpecialMessage("YOU KILLED THE KING!", 30);
                if (oa && 0 != this.killReason) {
                    this.beingDeleted = !0;
                    this.id == Z && z.shake(7 + .13 * r);
                    ...
                    this.playSounds && D.playSound(Dc, Ec * na * R,
                        1.1, sa, null)
                } else this.id == Z && (va.direction = 1, Z = 0, B = null, Ma = this.killReason), a = a + 4 + 4, delete y[this.id], this.cleanup();
                return a
            };
            ...
            this.onBlur = function() {
                this.playSounds && (D.sound.volume(0, ga), D.sound.volume(0, $), D.sound.volume(0,
                    V))
            };
        ...
        ic = function() {
            ...
            this.updateNetwork = function(b, a, e) {
                ...
                this.dstX = 10 * d;
                this.dstY = 10 * l;
                e ? (this.origX = this.dstX, this.origY = this.dstY, this.x = this.dstX, this.y = this.dstY, this.hue = b.getUint16(a, !0), a += 2, c = "hsl(" + this.hue + ", 100%, 50%)", f = t.frames.food.renderTintedFrame(c)) : this.canInterpolate = !0;
                this.lastUpdateTime = P;
                return a
            };
            this.deleteNetwork = function(b, a) {
                oa ? (this.beingDeleted = !0, this.beginGrabX = this.x, this.beginGrabY = this.y, 0 < this.killedByID && this.playSounds && (lastDistVolume = Ob(this.x,
                    this.y), D.playSound(Fc, Gc * lastDistVolume * R, 1.5, sa, null))) : delete y[this.id];
                return a
            };
            this.resume = function() {};
            this.cleanup = function() {};
        ...
        Hc = function() {
            ...
            this.preRenderSideLine = function(a) {
                ...
                b.lineCap = "round";
                b.moveTo(9, 9);
                a ? b.lineTo(9, 9 + 2 * d) : b.lineTo(9 + 2 *
                    d, 9);
            ...
            this.drawLimits = function(g) {
                ...
                g.save();
                g.translate(W, la);
                d + W <= e[1].x && (g.fillStyle = "#023139", g.fillRect(d, -d - 1E3, 1E3, 2E3 + 2 * d)); - d + W >= e[0].x &&
                    (g.fillStyle = "#023139", g.fillRect(-d - 1E3, -d - 1E3, 1E3, 2E3 + 2 * d)); - ca / 2 + la > e[0].y && (g.fillStyle = "#023139", g.fillRect(-d - 2, -d - 1E3, 2 * d + 4, 1E3));
                ca / 2 + la < e[1].y && (g.fillStyle = "#023139", g.fillRect(-d - 2, d, 2 * d + 4, 1E3));
                d + W <= e[1].x && g.drawImage(c, d - 9, -d - 9); - d + W >= e[0].x && g.drawImage(c, -d - 9, -d - 9); - ca / 2 + la > e[0].y && g.drawImage(f, -d - 9, -d - 9);
        ...
        Ic = function() {
            ...
            this.draw = function(f) {
                ...
                if (B) {
                    for (var e = B.renderedPoints,
                            g = [], b = e.length, l = 0; l < b; l++) {
                        var r = e[l].x + da / 2 - W,
                            v = e[l].y + ca / 2 - la,
                            r = r / da,
                            v = v / ca;
                    ...
                    f.stroke();
                    0 < pa && (r = Ha + da / 2 - W, v = Ia + ca / 2 - la, r /= da, v /= ca, f.translate(d + 120 * r * q, h + 120 * v * q), f.scale(.5, .5), t.frames.crown.draw(f))
                }
                f.restore()
            };
            this.update = function(a) {};
        ...
        Jc = function() {
            ...
            function f(a) {
                for (var b = 1;;) {
                    var c = a.getUint16(b, !0),
                        b = b + 2;
                    if (0 == c) {
                        b != a.byteLength && (pa = a.getUint16(b, !0), b +=
                            2, 0 < pa && (c = a.getFloat32(b, !0), b += 4, a = -a.getFloat32(b, !0), Za = Ha, $a = Ia, ab = 10 * c, bb = 10 * a, Xb = P));
                        break
                    }
                    ...
                    switch (d) {
                        ...
                        case 2:
                            ...
                            h = a.getUint8(b);
                            b += 1;
                            (g = y[c]) ? (g.killReason = h, g.killedByID = d, c = g == B, b = g.deleteNetwork(a, b), c && U && (U = !1, B = null, va.angle = Math.PI, va.throttle = 0, Y++, Fa = 0, s.localStorage.killCount =
                                Y, I.fastHideTalkLayer(), Ga || Kb())) : (console.log("ERROR: Entity does not exist: " + c), s.location.href = s.location.href);
                            break;
                        default:
            ...
            this.getServerAndConnect = function() {
                ...
                if (b) a = b, a = a.substring(1,
                    a.length), a = ";" + a, n.directed = !0;
            ...
            this.connect = function() {
                if (oa || debug) {
                    ...
                    } else 0 < n.roomNumber && (a = "ws:" +
                        a.split(":")[1] + ":" + (parseInt(n.roomNumber) + 8080));
            ...
            this.processMessage = function(e) {
                e = new DataView(e);
                var b = e.getUint8(0);
                if (1 == b) Xa && (e = +new Date -
                    h, H && H.updateLag(e), 150 < e ? this.ping() : setTimeout(function() {
                        n.ping()
                    }, 150 - e));
        ...
        Oc = function(a) {
            ...
            f.update = function(a) {
                ...
                for (var c in y) {
                    var d = y[c];
                    d.tutorial || (d.update(a), c == Z && (B = y[c]))
                }
                justTurned = !1;
                z.update(a);
                G.update(a);
                ...
                ia || N ? 1 == ia && 0 < e && (e -= a / 1E3 * 3, 0 >= e && (e = 0)) : (e += a / 1E3 * 3, 1 < e && (e = 1));
            ...
            f.draw = function(a) {
                if (t.loaded && (z.setupContext(g), Ya.draw(g), Vb)) {
                    if (T) {
                        for (var c in y) {
                            var d = y[c];
                            d.tutorial || (d.setAlpha(r), d.draw(g,
                                a))
                        }
                    ...
                    0 < e && !N && t.keysImage && (g.save(), g.globalAlpha = e, g.scale(q, q), g.translate(.5 * ea / q, .825 * V / q), g.drawImage(t.keysImage, -t.keysImage.width / 2, -t.keysImage.height / 2), g.restore());
                    0 < b && !N && t.boostImage && (g.save(), g.globalAlpha = b, g.scale(q,
                        q), g.translate(.5 * ea / q, .825 * V / q), g.drawImage(t.boostImage, -t.boostImage.width / 2, -t.boostImage.height / 2), g.restore());
                    U && zb.draw(g);
                    I.draw(g)
                }
            };
            ...
            var C = function() {
                ...
                H && (H.domElement.style.position = "absolute", H.domElement.style.left = (.31 * h.width - 100 / b) * b + "px", H.domElement.style.top = h.height * b - 18 - 30 + "px")
            };
            f.getMouseWorldPosition = function() {
                var b = 1;
                aa || (b = 2);
                return {
                    x: (Rb + (z.x * z.zoom - h.width * b / 2)) / z.zoom,
                    y: (Sb + (z.y * z.zoom - h.height * b / 2)) / z.zoom
                }
            };
            (function() {
                h = a;
        ...
        gb = function() {
            ...
            this.generateTintImage2 = function(b, d, f, v) {
                ...
                for (var u = n.getImageData(0, 0, this.width, this.height), m = u.data, s = m.length, q = 0; q < s;) m[q] =
                    m[q++] * (1 - v) + b * v, m[q] = m[q++] * (1 - v) + d * v, m[q] = m[q++] * (1 - v) + f * v, m[q] = .8 * m[q++];
            ...
            this.generateRGBKs = function() {
                ...
                d = d.getContext("2d");
                d.drawImage(h, a, c, this.width, this.height, 0, 0, this.width, this.height);
                for (var e = d.getImageData(0, 0, this.width, this.height).data, g = e.length, f = this.getImageCopy(), k = this.getImageCopy(), n = this.getImageCopy(), d = this.getImageCopy(),
                        m = 0; m < g; m += 4) f.toData[m] = e[m], f.toData[m + 1] = 0, f.toData[m + 2] = 0, f.toData[m + 3] = e[m + 3], k.toData[m] = 0, k.toData[m + 1] = e[m + 1], k.toData[m + 2] = 0, k.toData[m + 3] = e[m + 3], n.toData[m] = 0, n.toData[m + 1] = 0, n.toData[m + 2] = e[m + 2], n.toData[m + 3] = e[m + 3], d.toData[m] = 0, d.toData[m + 1] = 0, d.toData[m + 2] = 0, d.toData[m + 3] = e[m + 3];
        ...
        Kc = function() {
            ...
            this.addBlast = function(a, c, b, d, f) {
                ...
                a =
                    1 - lb(a, c, O.x, O.y) / PLAY_DISTANCE;.01 < a && D.playSound(SOUND_PLANE_EXPL, a * f, 1, d, null)
            };
    ...
    gameSheetInfo = [
        ...
        ["skulleyesyellow", 44, 132, 24, 11, .5, .182],
    ...
    var Qc = function() {
        ...
        fc = function() {
            ...
            this.init = function(l, r, k) {
                ...
                a = r;
                c = k;
                for (l = 0; l < d; l++) r = new Qc, this.resetParticle(r), r.active = !1, r.time = 9999, f.push(r)
            };
        ...
        Mc = function() {
            ...
            a.update = function(t) {
                if (this.isInitialized &&
                    ...
                    7 == l && D ? (z -= .04, 0 > z && (z = 0, a.clear(), a.init(), nextTipID = 0, ba = !0)) : (z += .04, 1 < z && (z = 1));
                    c.setAlpha(z);
                    f.setAlpha(z);
                    if (d > za) {
                        if (void 0 != y[c.id])
                            ...
                            } else h += .5, w = {}, w.x = h, w.y = g, w.lastLen = 2, w.curLengthDst = 30, w.pointCount = 2, w.flags = 0, w.extraSpeed =
                                0, w.isFull = !1, w.newPointCount = 0, w = this.buildSnakePacket(w), c.updateNetwork(w, 0, !1);
                        w = {
                            newPointCount: 0
                        };
                        ...
                        if (2 == l ||
                            4 == l) 2 == l ? -1.2 < b ? (l = 3, k++, w.newPointCount = 1, w.newPoints = [], w.newPoints.push({
                            x: e,
                            y: b
                        }), nextTipID = 1, ba = !0) : b += q : .8 < b ? (l = 5, k++, w.newPointCount = 1, w.newPoints = [], w.newPoints.push({
                            x: e,
                            y: b
                        })) : b += q;
            ...
            a.draw = function(a) {
                ...
                var d = 1.4 / b;
                a.save();
                a.translate(ea / 2 - 435 * ma / b, .5 * V - 209 * ma / b);
                a.scale(d * ma, d * ma);
            ...
            a.initSnake = function(a) {
                var d = {};
                0 == a ? (c = new Cb, c.playSounds = !1, c.tutorial = !0, c.id = t++, y[c.id] = c, x = c.id, d.lastLen = 2, d.curLengthDst = 30, d.pointCount = 2, d.flags = 0, d.extraSpeed = 0, d.isFull = !0, d.points = [], d.points.push({
                    x: h,
                    y: g
                }), h += 30, d.points.push({
                    x: h,
        ...
        tc = function() {
            ...
            this.draw = function(a) {
                f = this.visible ? f + (0 - f) / 10 : f + (1 - f) / 10;.99 < f || (a.translate(10 + -190 * f, 100), a.scale(q, q), a.font = "Bold 15px 'proxima-nova-1','proxima-nova-2', Arial", a.fillStyle = "rgba(0, 255, 255, 1.0)", a.shadowBlur = 5, a.shadowColor = "rgba(0, 200, 200, 1.0)", B && (255 > B.talkStamina ? (a.fillText("CANT TALK YET", 20, 15), I.drawTalkWaitFx(a, 160, 8, 4, B.talkStamina / 255), a.globalAlpha = .5) : a.fillText("PRESS A NUMBER", 20, 15)), a.shadowBlur = 0, a.drawImage(c, 0, 0), a.globalAlpha = 1)
            };
            this.preRender =
                function(a, c) {
                    c.width = 180;
    ...
    s.onload = function() {
        oc();
        Modernizr.canvas && Modernizr.websockets ? (null == L && (s.devicePixelRatio && (sb = 1 < s.devicePixelRatio ? 2 : 1), L =
            new Oc(x.getElementById("canvas")), s.addEventListener("resize", L.resize, !1), va = new rc, va.addListeners(), s.requestAnimationFrame ? s.requestAnimationFrame(Bb) : setInterval(Bb, 1E3 / 60), k("#overlay").show()), L.resize(), Eb()) : debug && console.log("unsupported-browser!")
    }
